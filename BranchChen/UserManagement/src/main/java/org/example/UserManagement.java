...
public class UserManagement {
    ...
    private void showUserProfile(User user) {
        ...
        profilePanel.add(createLabeledField("Name:", nameField));
        profilePanel.add(createLabeledField("Contact Info:", contactInfoField));
        profilePanel.add(createLabeledField("Preferences:", preferencesField));
        profilePanel.add(Box.createRigidArea(new Dimension(0, 20)));
        ...
        updateButton.addActionListener(new UpdateProfileAction(user));

        frame.revalidate();
        frame.repaint();
    }

    private class UpdateProfileAction implements ActionListener {
        private User user;

        public UpdateProfileAction(User user) {
            this.user = user;
        }
